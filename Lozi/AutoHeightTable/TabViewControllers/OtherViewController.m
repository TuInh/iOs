...
- (void)viewDidLoad {
    ...
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/999/photos?cityId=%ld&t=popular",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Phổ biến "];
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/999/photos?cityId=%ld&t=latest",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Mới nhất "];
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/999/photos?cityId=%ld&t=opening",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Đang mở cửa "];
    ...
    [self.headerImage setImage:[UIImage imageNamed:@"ic_other_fragment_header"]];
    ...
    [self.headerTitleLabel setText:@"Đăng gì cũng bán"];
    ...
    [self.headerDescriptionLabel setText:@"Tìm gì không thấy, vào đây có liền. Đăng bán 👉 Bán 👉 Khác 👉 Ta daa!"];
    ...
    */
    ...
    [self.foodCollectionView setDataLoader: [[FoodLoader alloc]init] withStartPage:[NSString stringWithFormat: @"%@/topics/999/photos?t=popular", [AppConfig GetBaseNextPageUrl]]];
