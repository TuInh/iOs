...
- (void)viewDidLoad {
    ...
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/2/photos?cityId=%ld&t=popular",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Phổ biến "];
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/2/photos?cityId=%ld&t=latest",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Mới nhất "];
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/2/photos?cityId=%ld&t=opening",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Đang mở cửa "];
    ...
    [self.headerImage setImage:[UIImage imageNamed:@"ic_fashion_fragment_header"]];
    ...
    [self.headerTitleLabel setText:@"Vừa up là bán"];
    ...
    [self.headerDescriptionLabel setText:@"Tất tật áo váy phụ kiện cho con gái. Đăng bán\nBán 👉 Góc con gái, phụ kiện mỹ phẩm 👉 Ta daa!"];
    ...
    */
    ...
    [self.foodCollectionView setDataLoader: [[FoodLoader alloc]init] withStartPage:[NSString stringWithFormat: @"%@/topics/2/photos?t=popular", [AppConfig GetBaseNextPageUrl]]];
