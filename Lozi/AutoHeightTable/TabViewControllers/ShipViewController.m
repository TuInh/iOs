...
- (void)viewDidLoad {
    ...
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/3/photos?cityId=%ld&t=popular",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Phổ biến "];
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/3/photos?cityId=%ld&t=latest",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Mới nhất "];
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/3/photos?cityId=%ld&t=opening",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Đang mở cửa "];
    ...
    [self.headerTitleLabel setText:@"Giao hàng muôn nơi"];
    ...
    [self.headerDescriptionLabel setText:@"Bấm máy alô, đồ ăn đến cửa. Đăng bán 👉 Bán 👉 Đồ ăn ship 👉 Ta daa!"];
    ...
    */
    ...
    [self.foodCollectionView setDataLoader: [[FoodLoader alloc]init] withStartPage:[NSString stringWithFormat: @"%@/topics/3/photos?t=popular", [AppConfig GetBaseNextPageUrl]]];
