...
- (void)viewDidLoad {
    ...
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/4/photos?cityId=%ld&t=popular",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Phổ biến "];
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/4/photos?cityId=%ld&t=latest",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Mới nhất "];
    [self.urlDictionary setObject: [NSString stringWithFormat: @"%@/topics/4/photos?cityId=%ld&t=opening",[AppConfig GetBaseNextPageUrl], [AppConfig GetCityID]] forKey: @" Đang mở cửa "];
    ...
    [self.headerTitleLabel setText:@"Đep lên ngay"];
    ...
    [self.headerDescriptionLabel setText:@"Biến hoá bản thân từ chân tới tóc với đủ dịch vụ làm đẹp👉 Bán 👉 Tóc móng và làm đẹp 👉 Ta daa!"];
    ...
    [self.foodCollectionView setDataLoader: [[FoodLoader alloc]init] withStartPage:[NSString stringWithFormat: @"%@/topics/4/photos?t=popular", [AppConfig GetBaseNextPageUrl]]];
